...
/**
 * Agro-Mitra App (Demo + Fertilizer Calculator + Advisory)
 * Paste this into frontend/src/App.jsx (overwrite existing)
 */
...
export default function App(){
  ...
  const [fertForm,setFertForm] = useState({ crop: "Maize", soil: "loamy", area: 1 });
  ...
  // advisory form state
  const [advForm,setAdvForm] = useState({ name:"", village:"", crop:"Maize", soil:"clay", area:1, location:"Patna,IN", extra:"" });
  ...
  async function runFertilizerCalc(e){
    ...
    try{
      ...
      setFertError(err.message || "Unknown error");
    } finally {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      {/* Demo / Recommendation form */}
      <div className="mb-6">
        <button onClick={runDemo} disabled={loading} className="bg-green-600 hover:bg-green-700 px-4 py-2 rounded-md text-white mr-3">
